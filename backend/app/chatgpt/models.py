...
class ChatgptCar(models.Model):
    ...
    created_time = models.IntegerField(db_index=True, blank=True, verbose_name="Creation time")
    updated_time = models.IntegerField(db_index=True, blank=True, verbose_name="Updated time")
